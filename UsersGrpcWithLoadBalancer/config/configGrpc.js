...
const configLoadBalancerUsers = {
    ...
    serverUrl: '192.168.0.177:6000', // URL del balanceador de carga
    address: '192.168.0.177:6000', // Dirección del balanceador de carga
    timeout: 5000, 
    retry: {
...
const configUserService = {
    ...
    serverUrl: '192.168.0.177:5000', // URL del microservicio UserService
    address: '192.168.0.177:5000', // Dirección del microservicio UserService
    timeout: 5000, 
    retry: {

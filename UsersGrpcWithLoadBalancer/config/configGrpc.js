...
const configLoadBalancerUsers = {
    ...
    serverUrl: `${localIP}:6000`, // URL del balanceador de carga
    address:  `${localIP}:6000`, // Dirección del balanceador de carga
    timeout: 5000, 
    retry: {
    ...
    maxCpuUsage: 10, // Porcentaje máximo de uso de CPU permitido para el balanceador de carga
...
let configUserService = {
    ...
    serverUrl:  `${localIP}:5000`, // URL del microservicio UserService
    address:  `${localIP}:5000`, // Dirección del microservicio UserService
    timeout: 5000, 
    retry: {
